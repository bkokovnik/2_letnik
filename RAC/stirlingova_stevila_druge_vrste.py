...
def stirling(n, k):
    if n == 0 and k == 0:
        return 1
    elif (n == 0 or k == 0) and (k >= 0 or n >= 0):
        return 0
    else:
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDA4MSwidXNlciI6ODA2MX0:1rhpv3:vBHCnhJeEExNV3CMTdVX_yyj6xD0j5V6vPlImu9xUfg"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDA4MiwidXNlciI6ODA2MX0:1rhpv3:bYzFA_MDBGfi5ebQB3X5vm3s0q_Veyyh-VdiKDSz9LM"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDA4MywidXNlciI6ODA2MX0:1rhpv3:2SVgde_S47PK6AV6m1mSoliOrMzSji52fnjS5HrK4DA"
        try:
