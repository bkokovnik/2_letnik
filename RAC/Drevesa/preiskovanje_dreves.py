...
# =============================================================================
    def minimum(self):
        if self.prazno:
            ...
            k = [self.vsebina, self.levo.minimum(), self.desno.minimum()]
            k = [v for v in k if v is not None]
            return min(k)
# =====================================================================@005915=
# 4. podnaloga
...
# =============================================================================
    def premi_pregled(self):
        if not self.prazno:
            ...
            for v in self.levo.premi_pregled():
                yield v
            
            for v in self.desno.premi_pregled():
                yield v
# =====================================================================@005916=
# 5. podnaloga
...
# =============================================================================
    def vmesni_pregled(self):
        if not self.prazno:
            ...
            for v in self.levo.vmesni_pregled():
                yield v

            yield self.vsebina
            
            for v in self.desno.vmesni_pregled():
                yield v        
# =====================================================================@005917=
# 6. podnaloga
...
# =============================================================================
    def po_nivojih(self):
        vrsta = [self]
        while vrsta:
            trenutni = vrsta.pop(0)
            if not trenutni.prazno:
                yield trenutni.vsebina
                vrsta.append(trenutni.levo)
                vrsta.append(trenutni.desno)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo1OTEyLCJ1c2VyIjo4MDYxfQ:1s9j0a:dLA9hvrsgGUQ-Jr-CYghE8tdICVE5nORr3UL3cd-lps"
        try:
            test_data = [
                ('Drevo().vsota()', 0),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo1OTEzLCJ1c2VyIjo4MDYxfQ:1s9j0a:etmcl5JktqSqrfgoc1GhoskLB5PeGTil88WMrmY4iLE"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo1OTE0LCJ1c2VyIjo4MDYxfQ:1s9j0a:kDb1jQbDqxXXIqbt-OflVNooVKOcj_9Z_YCGkb0N5pM"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo1OTE1LCJ1c2VyIjo4MDYxfQ:1s9j0a:cKl2EQ4b3jPTcbLL7jxgjTjElI09SfLg5noqNNgvtyo"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo1OTE2LCJ1c2VyIjo4MDYxfQ:1s9j0a:_Eq13SCm01QePU-vn-r8nAZs__jYi7Kiv-2kw5VgAuo"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo1OTE3LCJ1c2VyIjo4MDYxfQ:1s9j0a:fVZex6YA33WsCVW-ZRh3fBdquzL0uaql_WO-HmGk98I"
        try:
            test_data = [
