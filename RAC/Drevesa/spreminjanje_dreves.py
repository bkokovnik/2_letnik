...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo1OTE4LCJ1c2VyIjo4MDYxfQ:1s9j0d:gVygCp6K7liYd4KBLpQwzd2_984TP7oK2jegSxyw69k"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo1OTE5LCJ1c2VyIjo4MDYxfQ:1s9j0d:dzcSNoKkCq40n29tY9ZhCXOB3AL2Q8ArZyFd32s2zDY"
        try:
            test_data = [
                (["d = Drevo(5, levo=Drevo(3), desno=Drevo(2))",
