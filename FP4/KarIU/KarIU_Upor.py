...
a1 = np.genfromtxt(r"FP4\KarIU\Podatki\R100HZ.csv", delimiter=',', encoding="utf-8", skip_header=15)
...
plt.plot(U2, U1 * 10e3, ".", markersize=3)

graf_oblika("Karakteristika upora", r"$U\ $ [V]", r"$I$ [mA]", legenda=0)

optim, pcov = fit_napake_x(U1_unc, U2_unc)
