...
j0_5 = unc.ufloat(optimized_params_5[0], np.sqrt(covariance_5[0, 0]))
D_5 = unc.ufloat(optimized_params_5[1], np.sqrt(covariance_5[1, 1]))
d_5 = unc.ufloat(optimized_params_5[2], np.sqrt(covariance_5[2, 2]))



print("#########   5 rež   ##########\n", 
      "Amplituda j_0:", j0_5, "\n", 
      "Amplituda j_0*n^2:", j0_5 * 5**2, "\n", 
      "Širina rež D: ", D_5, " m\n",
      "Razdalja med režami d: ", d_5, " m\n")
...
plt.xlabel(r'$\phi$ [rad]')
plt.ylabel('$j/j_0$')
plt.title("Zaslon s tremi režami")
x_limits = plt.xlim()
y_limits = plt.ylim()
plt.ylim(y_limits)
plt.xlim(x_limits)
...
j0_3 = unc.ufloat(optimized_params_3[0], np.sqrt(covariance_3[0, 0]))
D_3 = unc.ufloat(optimized_params_3[1], np.sqrt(covariance_3[1, 1]))
d_3 = unc.ufloat(optimized_params_3[2], np.sqrt(covariance_3[2, 2]))



print("#########   3 reže   ##########\n", 
      "Amplituda j_0:", j0_3, "\n", 
      "Amplituda j_0*n^2:", j0_3 * 3**2, "\n", 
      "Širina rež D: ", D_3, " m\n",
      "Razdalja med režami d: ", d_3, " m\n")
...
plt.xlabel(r'$\phi$ [rad]')
plt.ylabel('$j/j_0$')
plt.title("Zaslon z dvema režama")
x_limits = plt.xlim()
y_limits = plt.ylim()
plt.ylim(y_limits)
plt.xlim(x_limits)
...
D_2 = unc.ufloat(optimized_params_2[1], np.sqrt(covariance_2[1, 1]))
d_2 = unc.ufloat(optimized_params_2[2], np.sqrt(covariance_2[2, 2]))



print("#########   2 reži   ##########\n", 
      "Amplituda j_0:", j0_2, "\n", 
      "Amplituda j_0*n^2:", j0_2 * 2**2, "\n", 
      "Širina rež D: ", D_2, " m\n",
      "Razdalja med režami d: ", d_2, " m\n")
...
j0_1 = unc.ufloat(optimized_params_1[0], np.sqrt(covariance_1[0, 0]))
D_1 = unc.ufloat(optimized_params_1[1], np.sqrt(covariance_1[1, 1]))
