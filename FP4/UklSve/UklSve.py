...
plt.ylabel('$j$')
plt.title("Primerjava zaslonov s petimi in tremi režami")
x_limits = plt.xlim()
y_limits = plt.ylim()
plt.ylim(y_limits)
plt.xlim(x_limits)
...
plt.plot(x_smooth_3, fit_krivulja(x_smooth_3, *optimized_params_3), label='3 reže (fit)', zorder=2)
# plt.plot(x_3, y_3, ".", markersize=3, label="3 reže (izmerjeno)", zorder=1)
#####################################
...
plt.xlabel(r'$\phi$ [rad]')
plt.ylabel('$j$')
plt.title("Primerjava zaslonov s tremi in dvema režama")
x_limits = plt.xlim()
y_limits = plt.ylim()
plt.ylim(y_limits)
plt.xlim(x_limits)
...
plt.xlabel(r'$\phi$ [rad]')
plt.ylabel('$j$')
plt.title("Primerjava zaslonov z dvema in eno režo")
x_limits = plt.xlim()
y_limits = plt.ylim()
plt.ylim(y_limits)
plt.xlim(x_limits)
